              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <img
                    ...
                    src="/assets/_external/cdn.jsdelivr.net/gh/lipis/flag-icons/flags/4x3/us.svg"
                    style={{
            ...
            <>
              ...
              <div className="flex flex-none items-center pr-4">
                <Link to="/" className="flex flex-col group">
                  {/* Official Cryptorefill SVG Logo */}
                  <svg
                    width="720"
                    height="127"
                    viewBox="0 0 720 127"
